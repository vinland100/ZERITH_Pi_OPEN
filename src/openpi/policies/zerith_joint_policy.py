...
def make_Dualarx_example() -> dict:
    """Creates a random input example for the Libero policy."""
    return {
        "observation/state": np.random.rand(14),
        "observation/image": np.random.randint(256, size=(848, 480, 3), dtype=np.uint8),
...
class MobilearxInputs(transforms.DataTransformFn):
    """
...
@dataclasses.dataclass(frozen=True)
class MobilearxOutputs(transforms.DataTransformFn):
    """
